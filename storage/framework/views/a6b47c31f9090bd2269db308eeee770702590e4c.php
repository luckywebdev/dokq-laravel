		...
		<div class="page-content">
			...
			<div class="row margin-top-20">
				<div class="offset-md-1 col-md-10">
				    <input type="hidden" id="book_id" name="book_id" value="<?php echo e($bookId); ?>">
					<table class="table table-no-border table-hover">
						<tr>
							<td class="h4 text-md-right">合格した本のタイトル：</td>
							<td class="h4 text-md-left"><?php echo e($book->title); ?></td>
						</tr>
						<tr>
							<td class="h4 text-md-right">合格ポイント：</td>
							<td class="h4 text-md-left"><?php echo e(floor($book->point*100)/100); ?>ポイント</td>
						</tr>
						<tr>
							<td class="h4 text-md-right">受検に要した時間：</td>
							<td class="h4 text-md-left">
							 <?php echo e(floor($test_time/60)); ?>分<?php echo e($test_time%60); ?>秒 /
							 <?php echo e(floor($book->test_short_time/60)); ?>分<?php echo e($book->test_short_time%60); ?>秒 
							(全<?php echo e($quiz_count); ?>問)
							</td>
						</tr>
						<?php if($savetime == 1): ?>
						<tr>
							<td class="h4 text-md-right">短時間加算ポイント：</td>
							<td class="h4 text-md-left"><?php echo e(floor(($book->point/10)*100)/100); ?>ポイント</td>
						</tr>
						<tr>
							<td class="h4 text-md-right" style="color:red">合計：</td>
							<td class="h4 text-md-left" style="color:red"><?php echo e(floor($book->point*100)/100 + floor(($book->point/10)*100)/100); ?>ポイントを取得しました。</td>
						</tr>
						<?php else: ?>
						<tr>
							<td class="h4 text-md-right" style="color:red">合計：</td>
							<td class="h4 text-md-left" style="color:red"><?php echo e(floor($book->point*100)/100); ?>ポイントを取得しました。</td>
						</tr>
						<?php endif; ?>
						<tr>
							<td class="h4 text-md-right">続けて違う本を受検</td>
							<td class="text-md-left">
								<a href="<?php echo e(url('/book/search')); ?>" class="btn btn-warning" style="margin-top: 5px; margin-bottom: 5px">本を検索して受検</a>
								<a href="<?php echo e(url('/mypage/wish_list')); ?>" class="btn btn-warning" style="margin-top: 5px; margin-bottom: 5px">マイ書斎から受検</a>
							</td>
						</tr>
						<tr>
							<td class="h4 text-md-right">終了してトップ画面に戻る</td>
							<td class="text-md-left">
								<a href="<?php echo e(url('/')); ?>" class="btn btn-info" url="">読Qトップに戻る</a>
							</td>
						</tr>
						<tr>
							<td class="h4 text-md-right">終了してログアウトする</td>
							<td class="text-md-left">
								<a href="<?php echo e(route('logout')); ?>" class="btn btn-danger">終了してログアウト</a>
							</td>
						</tr>
					</table>
				</div>
    ...
    <script>
	   $(document).ready(function(){
		...
		function ajaxRegTest() {
			var info = {
                book_id: $("#book_id").val(),
                passed_quiz_count: <?php echo e($quiz_count); ?>,
                passed_test_time: <?php echo e($test_time); ?>,
                passed_point: <?php echo e(floor($passed_point*100)/100); ?>,
