				...
				<div class="col-md-6 column">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="<?php echo e(url('/mypage/demand_list')); ?>">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box yellow">
						...
						<div class="portlet-body">
							<div class="row">
								...
								<div class="col-md-12">
									<a class="" href="<?php echo e(url('mypage/category')); ?>">もっと見る</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="table-scrollable">
								<table class="table table-bordered table-hover">
									...
									<tbody class="text-md-center">
										...
										<tr class="info text-md-center">
											<td class="align-middle"><a <?php if($demand->Book->active >= 3): ?> href="<?php echo e(url('/book/' . $demand->Book->id . '/detail')); ?>" <?php endif; ?> class="font-blue-madison"><?php echo e($demand->Book->title); ?></a></td>
											<td class="align-middle"><a href="<?php echo e(url('book/search_books_byauthor?writer_id=' . $demand->Book->writer_id.'&fullname='.$demand->Book->firstname_nick.' '.$demand->Book->lastname_nick)); ?>" class="font-blue-madison"><?php echo e($demand->Book->firstname_nick.' '.$demand->Book->lastname_nick); ?></a></td>
											<td class="align-middle">dq<?php echo e($demand->Book->id); ?></td>
											<td class="align-middle"><?php $__currentLoopData = $demand->Book->category_names(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $one): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e($one."、"); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></td>
											<td class="align-middle"><?php echo e(floor($demand->Book->point*100)/100); ?></td>
										</tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</tbody>
								</table>
								...
								<table class="table table-bordered table-hover">
									...
									<tbody class="text-md-center">
										...
										<tr class="info text-md-center">
											<td class="align-middle"><a <?php if($book->active >= 3): ?> href="<?php echo e(url('/book/'.$book->id.'/detail')); ?>" <?php endif; ?> class="font-blue-madison"><?php echo e($book->title); ?></a></td>
											<td class="align-middle"><a href="<?php echo e(url('book/search_books_byauthor?writer_id=' . $book->writer_id.'&fullname='.$book->firstname_nick.' '.$book->lastname_nick)); ?>" class="font-blue-madison"><?php echo e($book->firstname_nick.' '.$book->lastname_nick); ?></a></td>
											<td class="align-middle"><?php echo e($book->pages); ?></td>
											<td class="align-middle"><?php echo e(floor($book->point*100)/100); ?></td>
											<td class="align-middle"><?php echo e($book->is_public == 1 ? '公開':'非公開'); ?></td>
										</tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</tbody>
								</table>
					...
					<div class="col-md-12">
						<h4 class="font-blue col-md-11">読書推進活動ランキング<span class="font-blue" style="font-size:14px">（同年代内順位）</span></h4>
