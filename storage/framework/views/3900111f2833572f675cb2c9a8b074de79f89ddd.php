...
$(document).ready(function(){
    ...
    $(".btn-failed").click(function(){
        ...
        <?php if(Auth::user()->isPupil() && Auth::user()->active == 1): ?>
    ...
    $(".btn-prev").click(function(){
        ...
        $("#form").attr("action",'<?php echo e(url("/book/test/caution")); ?>');
        $("#form").submit();
    });

    $(".btn-next").click(function(){
        $("#form").attr("method", "post")
        $("#form").attr("action",'<?php echo e(url("/book/test/signin_teacher")); ?>');
        $("#form").submit();
    });
        ...
        $.ajax({
            ...
            success: function (response){
                ...
                if(response.status == 'success'){
                    ...
                    setTimeout(function(){
                        //location.href='/book/test/mode_recog?book_id=' + $("#book_id").val()+'&examinemethod=0';
                        location.href='/book/test/mode_recog?book_id=' + $("#book_id").val();
                    },2000);
...
<div class="login">
    ...
    <div class="container content1">
        ...
        <?php endif; ?>
    <form class="form-horizontal form-row-seperated " id="form" role="form" action="">
