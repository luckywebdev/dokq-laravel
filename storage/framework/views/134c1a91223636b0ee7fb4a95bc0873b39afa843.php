	...
	<div class="form-body">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('pages') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">
					...
					<div class="col-md-9 spin">
						<input type="number" min="0" name="pages" value="<?php echo e(old('pages')!='' ? old('pages'): (isset($book)? $book->pages: '0')); ?>" class="param spinner-input form-control" maxlength="3" id="input_8">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('max_rows') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="max_rows" value="<?php echo e(old('max_rows')!='' ? old('max_rows'): (isset($book)? $book->max_rows: '0')); ?>" class="param calc form-control" maxlength="3" id="input_9">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('max_chars') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="max_chars" value="<?php echo e(old('max_chars')!='' ? old('max_chars'): (isset($book)? $book->max_chars: '0')); ?>" class="param calc form-control" maxlength="3" id="input_10">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('entire_blanks') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="entire_blanks" value="<?php echo e(old('entire_blanks')!='' ? old('entire_blanks'): (isset($book)? $book->entire_blanks: '0')); ?>" class="param calc form-control" maxlength="3" id="input_11">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('quarter_filled') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="quarter_filled" value="<?php echo e(old('quarter_filled')!='' ? old('quarter_filled'): (isset($book)? $book->quarter_filled: '0')); ?>" class="param calc form-control" maxlength="3" id="input_12">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('half_blanks') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="half_blanks" value="<?php echo e(old('half_blanks')!='' ? old('half_blanks'): (isset($book)? $book->half_blanks: '0')); ?>" class="param calc form-control" maxlength="3" id="input_13">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('quarter_blanks') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
						<input type="number" min="0" name="quarter_blanks" value="<?php echo e(old('quarter_blanks')!='' ? old('quarter_blanks'): (isset($book)? $book->quarter_blanks: '0')); ?>" class="param calc form-control" maxlength="3" id="input_14">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p30') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p30" value="<?php echo e(old('p30')!='' ? old('p30'): (isset($book)? $book->p30: '0')); ?>" class="param calc form-control" maxlength="3" id="input_15">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p50') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p50" value="<?php echo e(old('p50')!='' ? old('p50'): (isset($book)? $book->p50: '0')); ?>" class="param calc form-control" maxlength="3" id="input_16">
			...
			<div class="col-md-12  margin-bottom-5  <?php echo e($errors->has('p70') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p70" value="<?php echo e(old('p70')!='' ? old('p70'): (isset($book)? $book->p70: '0')); ?>" class="param calc form-control" maxlength="3" id="input_17">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p90') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p90" value="<?php echo e(old('p90')!='' ? old('p90'): (isset($book)? $book->p90: '0')); ?>" class="param calc form-control" maxlength="3" id="input_18">
			...
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('p110') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" min="0" name="p110" value="<?php echo e(old('p110')!='' ? old('p110'): (isset($book)? $book->p110: '0')); ?>" class="param calc form-control" maxlength="3" id="input_19">
		...
		<div class="row">			
			<div class="col-md-12  margin-bottom-5 <?php echo e($errors->has('total_chars') ? ' has-danger' : ''); ?>">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-10 spin">
					<input type="number" value="<?php echo e(old('total_chars')!='' ? old('total_chars'): (isset($book)? $book->total_chars: '0')); ?>" name="total_chars" id="total_chars" readonly class="form-control" maxlength="6">
		...
		<div class="row">
			...
			<div class="col-md-12  margin-bottom-5 ">
				...
				<div class="form-group col-md-5">					
					<div class="col-md-9">
					<input type="text" name="point" value="<?php echo e(old('point')!='' ? old('point'): (isset($book)? floor($book->point*100)/100: '0')); ?>" readonly="true" class="form-control" id="point">
					</div>
