				...
				<div class="col-md-12">
					<div class="col-md-2 ">
						<ul style="list-style:none">
							...
							<li><a href="<?php echo e(url('/')); ?>" style="font-size: 150%">新しい読Q本</a></li>
						...
						<ul style="list-style:none">
							...
							<li><a href="<?php echo e(url('/auth/login')); ?>" style="font-size: 150%">ログイン</a></li>
							<li><a href="<?php echo e(url('/auth/register/0/1')); ?>" style="font-size: 150%">学校団体新規登録</a></li>
							<li><a href="<?php echo e(url('/auth/viewpdf/group')); ?>" style="font-size: 150%">学校団体利用規約と申し込みの流れ（PDF)</a></li>
							<li><a href="<?php echo e(url('/auth/register/1/1')); ?>" style="font-size: 150%">一般会員新規登録</a></li>
							<li><a href="<?php echo e(url('/auth/viewpdf/user')); ?>" style="font-size: 150%">一般会員利用規約と申し込みの流れ（PDF)</a></li>
							<li><a href="<?php echo e(url('/auth/register/2/1')); ?>" style="font-size: 150%">監修者会員新規登録</a></li>
							<li><a href="<?php echo e(url('/auth/viewpdf/overseer')); ?>" style="font-size: 150%">監修者会員利用規約と申し込みの流れ（PDF)</a></li>
							<li><a href="<?php echo e(url('/auth/register/3/1')); ?>" style="font-size: 150%">著者会員新規登録</a></li>
							<li><a href="<?php echo e(url('/auth/viewpdf/author')); ?>" style="font-size: 150%">著者会員利用規約と申し込みの流れ（PDF)</a></li>
						</ul>
					</div>
					<div class="col-md-2">
						<ul style="list-style:none">
							<li><a href="" style="font-weight: bold; color: #fd73cf; font-size: 180%">読Qとは</a></li>
							<li><a href="<?php echo e(url('/about_site')); ?>" style="font-size: 150%">読Qの特長</a></li>
							<li><a href="<?php echo e(url('/about_score')); ?>" style="font-size: 150%">読Qの使い方</a></li>
							<li><a href="<?php echo e(url('/about_target')); ?>" style="font-size: 150%">ポイントのしくみと取得目標</a></li>
							<li><a href="<?php echo e(url('/about_overseer')); ?>" style="font-size: 150%">監修者紹介</a></li>
							<li><a href="<?php echo e(url('/about_test')); ?>" style="font-size: 150%">受検問題サンプル</a></li>
							<li><a href="<?php echo e(url('/about_recog')); ?>" style="font-size: 150%">顔認証について</a></li>
							<li><a href="<?php echo e(url('/outline')); ?>" style="font-size: 150%">法人概要</a></li>
							<li><a href="<?php echo e(url('/agreement')); ?>" style="font-size: 150%">利用規約</a></li>
							<li><a href="<?php echo e(url('/about_pay')); ?>" style="font-size: 150%">会費・料金について</a></li>
							<li><a href="<?php echo e(url('/security')); ?>" style="font-size: 150%">個人情報保護方針</a></li>
							<li><a href="<?php echo e(url('/ask')); ?>" style="font-size: 150%">お問合せ</a></li>
							<li><a href="<?php echo e(url('/faq')); ?>" style="font-size: 150%">よくある質問</a></li>
						</ul>
					</div>
					...
					<div class="col-md-2">
						<ul style="list-style:none">
							...
							<li><a href="<?php echo e(url('/book/search')); ?>" style="font-size: 150%">本の検索</a></li>
							<li><a href="<?php echo e(url('/book/search/help')); ?>" style="font-size: 150%">検索のしかた</a></li>
							<li><a href="<?php echo e(url('/book/result/help')); ?>" style="font-size: 150%">検索結果の見方</a></li>
						</ul>
						<ul style="list-style:none">
