				...
				<div class="col-md-6 column">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="<?php echo e(url('/mypage/mybooklist')); ?>">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box red">
						<div class="portlet-title">
							...
							<?php if($age >= 15): ?>
								<div class="tools">
									<input type="checkbox" <?php if($author_readers_is_public == 1): ?> checked <?php endif; ?> class="make-switch" data-size="small" id="author_readers_is_public">
								</div>
							<?php endif; ?>
						</div>
						<div class="portlet-body">
							<div id = "canvas_parent" class="table-scrollable-all scroller" style = "width:200%;height:300px;text-align:center; overflow-x: auto">
								<!-- <div id="chart_1_1_legendPlaceholder">
								</div>
								<div id="chart_1_1" class="chart">
								</div> -->
								<canvas id="authorbar" width = "2000" height= "300"></canvas>
							</div>
						</div>
						<!-- <div class="slimScrollBar" style="background: rgb(161, 178, 189); width: 7px; position: absolute; top: 36px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 144px;"></div> -->
					</div>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="<?php echo e(url('/mypage/overseer_books')); ?>">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">
							<div class="row">
											...
											<tr style="height: 300px;padding:12px;">
												...
												<td class="col-md-1 text-md-center" style="background-color:<?php echo e($color); ?>;padding-left:0px;padding-right:0px;">
													...
													<div class="row col-md-12" style="writing-mode:vertical-rl;margin-left:0px;margin-right:0px;padding-left:0px;padding-right:0px;height:100px;">
														<h5 class="font_gogic text-md-left" style="align-self:center;font-family:HGP明朝B;">
															<a class="font_gogic" style="text-decoration:none;font-family:HGP明朝B;" href="<?php echo e(url('book/search_books_byauthor?writer_id=' . $book->writer_id.'&fullname='.$book->fullname_nick())); ?>">
															<?php echo e($book->fullname_nick()); ?>
									...
									<a href="<?php echo e(url('/mypage/category')); ?>" class="news-block-btn">もっと見る</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="<?php echo e(url('/mypage/bid_history')); ?>">もっと見る</a>
						</div>
					</div>
								...
								<table class="table table-bordered table-hover">
									<thead>
										<tr>
											...
											<?php if($age >= 15): ?>
											<th class="col-md-2">公開<br>非公開</th>
											<?php endif; ?>
										</tr>
									</thead>
									<tbody class="text-md-center">
										...
										<tr class="info">
											<td class="text-md-center align-middle"><a <?php if($book->active >= 3): ?> href="<?php echo e(url("/book/" . $book->id . "/detail")); ?>" <?php endif; ?> class="font-blue-madison"><?php echo e($book->title); ?></a></td>
											<td class="text-md-center align-middle"><a href="<?php echo e(url('/book/search_books_byauthor?writer_id=' . $book->writer_id.'&fullname='.$book->firstname_nick.' '.$book->lastname_nick)); ?>" class="font-blue-madison"><?php echo e($book->firstname_nick.' '.$book->lastname_nick); ?></a></td>
											...
											<td class="text-md-center align-middle wish_public" id="<?php echo e($book->id); ?>"><?php echo e($book->is_public == 1 ? '公開':'非公開'); ?></td>
										</tr>
										<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
									</tbody>
								</table>
							</div>
							<a class="text-md-center font-blue-madison" href="<?php echo e(url("/mypage/wish_list")); ?>">もっと見る</a>
						</div>
					</div>
				...
				<div class="col-md-6 column">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body" style="height: 350px;">
							...
							<div style="width:10%;float:left;text-align:left;height: 300px;"><span style="color:blue;vertical-align:middle;">市区町村内</span></div>
						...
						<div class="portlet-body" style="height: 350px;">
							<div style = 'font-size:8px;position:relative;left:50px;top:0px;text-align:left'>(pt)</div>
							<div style="width:10%;float:left;text-align:left;height: 300px;"><span style="color:blue;vertical-align:middle;">都道府県内</span></div>
...
<?php $__env->startSection('scripts'); ?>
	...
	<script src="<?php echo e(asset('js/charts/Chart1.js')); ?>"></script>
	...
	<script>
		...
		<?php foreach ($mywriteChartBooks as $book ): ?>
			aurthorLabel.push('<?php echo e($book->title); ?>'.toString());
		<?php endforeach ?>
		...
		var len_max = 0;
		<?php foreach ($mywriteChartBooks as $book ): ?>
			len_max = len_max < '<?php echo e($book->title); ?>'.length?'<?php echo e($book->title); ?>'.length:len_max;
		<?php endforeach ?>
		var data_count = aurthorLabel.length;
		var ctx=document.getElementById("authorbar").getContext("2d");
		document.getElementById("authorbar").height= $('#canvas_parent').height()-10;
		document.getElementById("authorbar").width = Number(data_count) * 100;
		//30 is scrollbar`s height
		//13 is rplaced if you set context`s font size, in Chart.js the default size is 13pt
		var margin = ($('#canvas_parent').width() - $('#authorbar').width())/2;
		// $('#authorbar').attr('style', "margin-left:"+margin+"px");
		$(window).resize(function(){
			// document.getElementById("authorbar").width = Number(data_count) * 80;
			var margin = ($('#canvas_parent').width() - $('#authorbar').width())/2;
			// $('#authorbar').attr('style', "margin-left:"+margin+"px");
		});
		new Chart(ctx).Bar(authorbarChartData, authorvarChartOption);
