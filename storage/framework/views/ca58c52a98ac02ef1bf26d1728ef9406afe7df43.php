...
$(document).ready(function(){
    ...
    $(".btn-next").click(function(){
        ...
        $("#face_form").attr("action",'<?php echo e(url("/mypage/signin_teacher")); ?>');
        $("#face_form").submit();
    });
...
<div class="login">
    <div class="logo">
        <a href="<?php echo e(url('/')); ?>" style="color:white; font-family: 'Judson', 'Maven Pro', sans-serif !important, HGP明朝B;">読Q</a>
    </div>
        ...
        <div class="modal-dialog modal-sm">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p><?php echo e(config('consts')['MESSAGES']['EMAIL_SERVER_ERROR']); ?></p>
            </div>
