...
<?php $__env->startSection('contents'); ?>
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title">読書認定書 <?php if(!$certi_preview->passcode ): ?>プレビュー <?php endif; ?></h3>
								...
								<div class="row">
                                    <div class="col-md-12">  
                                        ...
                                        <div class="tools text-md-right" style="float: right;">
                                            <span class="text-md-right text-md-top" style="float:right;"><?php echo e(date_format(date_create($certi_preview->backup_date), 'Y年m月d日')); ?></span>
									...
									<div class="col-md-12">
										...
										<h5 class="text-md-center">（パスコード： <?php if($certi_preview->passcode ): ?>　<?php echo e($certi_preview->passcode); ?> <?php else: ?> <?php echo e("       "); ?> <?php endif; ?>)</h5>
									</div>
									<div class="col-md-12 text-md-left">&nbsp;</div>
									<div class="col-md-12 text-md-left"><?php if($certi_preview->passcode ): ?> <?php echo e($user->fullname()); ?> <?php else: ?> <?php echo e("〇〇 〇〇"); ?>　<?php endif; ?> 様</div>
									<div class="col-md-12 text-md-left">(読Qネーム：　<?php if($certi_preview->passcode ): ?><?php echo e($user->username); ?><?php else: ?><?php echo e("〇〇〇〇"); ?><?php endif; ?> )</div>
						...
						<div style="width:100%;height:100%;border:solid 1px;">
							<div style="padding-top:20px; padding-bottom:20px; padding-left:20px; padding-right:20px;">
								<div class="row">
									...
									<div class="col-md-12 text-md-center">合計取得ポイント　　<?php echo e(floor($certi_preview->sum_point*100)/100); ?>&nbsp;ポイント</div>	
									<div class="col-md-12 text-md-left">&nbsp;</div>	
                                    <div class="col-md-12 text-md-center" style="text-align:center;font-size:14px;">合格した書籍一覧（著者名順）　　　　（<?php echo e(date_format(date_create($certi_preview->backup_date), 'Y年m月d日')); ?>現在)</div>    
									<div class="col-md-12 text-md-left">&nbsp;</div>					
									<div class="col-md-12">
										<?php $count = 0; ?>
										<?php
