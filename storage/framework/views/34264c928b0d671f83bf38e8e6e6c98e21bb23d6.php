		...
		<div class="page-content">
			<div class="row">
				<div class="col-md-12">
					...
					<input type="checkbox" class="make-switch col-md-1" <?php if($point_ranking_is_public == 1): ?>checked <?php endif; ?> id="point_ranking_is_public" data-size="small">
				</div>
			</div>
			<form action="<?php echo e(url('/mypage/rank_by_age')); ?>" method="get" id="rankingage_form">
			...
			<div class="row margin-top-10 margin-bottom-20">
				...
				<div class="col-md-3">
					<select class="bs-select form-control" <?php if($otherview_flag): ?> disabled="true" <?php endif; ?>>
				...
				<?php if(isset($myrank)): ?>					
					<table class="table table-bordered table-hover">
						...
						<tbody class="table-content text-md-center">
							...
							<tr class="warning text-md-center">
								<td class="align-middle"><?php echo e(Date('Y')); ?>年度<br>（今年度通算）</td>
								<td class="align-middle">
							...
							<tr class="text-md-center">
								<td class="align-middle"><?php echo e(Date('Y')-1); ?>年度<br>（前年度）</td>
								<td class="align-middle">
			...
			<div class="row">
				<div class="offset-md-5 col-md-5 col-xs-12" style="text-align:center">
					<a class="btn btn-warning" href="<?php echo e(url('/mypage/rank_graph/'.$id.'?otherview_flag='.$otherview_flag)); ?>">グラフで見る</a>
