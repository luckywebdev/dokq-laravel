...
<div class="container register">
	<div class="form">
		<form id="groupstep3-form" class="form-horizontal" method="post" role="form" action="<?php echo e(url('/auth/register/enterdetaildata')); ?>" enctype="multipart/form-data">
			<input type="hidden" name="refresh_token" value="<?php echo e($user->refresh_token); ?>" id="refresh_token"/>
			<input type="hidden" name="user_id" value="<?php echo e($user->id); ?>" id="user_id"/>
			<input type="hidden" name="fileno" value="<?php echo e($user->fileno); ?>" id="fileno"/>
			<input type="hidden" name="upfilename" value="<?php echo e(isset($_GET['upfilename']) ? $_GET['upfilename'] : ''); ?>" id="upfilename"/>
					...
					<table class="table table-bordered">
					    <tbody class="text-md-center">
					        ...
					        <tr>
						        ...
						        <td colspan="2">
						        	〒
						        	<?php echo e($user->address4); ?>―<?php echo e($user->address5); ?>
			...
			<div class="form-group row">
				<label class="control-label text-md-left col-md-10" style="font-size:16px">代表者本人確認書類アップロード:
					<a href="<?php echo e(url('/security')); ?>" class="caption-subject theme-font bold uppercase" style="font-size:12px">個人情報保護方針はこちら</a>
				</label>	
			</div>

			<div class="form-group row <?php echo e($errors->has('phone') ? ' has-danger' : ''); ?>" >
				<label class="control-label col-md-3 text-md-right"><?php echo e($auth_types['TITLE']); ?>:</label>
				<div class="col-md-4">
					<select name="auth_type" class="form-control bs-select">
						<?php $__currentLoopData = $auth_types['CONTENT']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$auth_type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<?php if($user->auth_type == $key): ?>
								<option value="<?php echo e($key); ?>" selected> <?php echo e($auth_type); ?> </option>
							<?php else: ?>
								<option value="<?php echo e($key); ?>"> <?php echo e($auth_type); ?> </option>
							<?php endif; ?>
			...
			<div class="row form-group"> 
                ...
                <div class="col-md-2 text-md-right">                        
					...
					<?php if(isset($user->ip_address) && $user->ip_address !== null && $user->ip_address !== ""): ?>
					<input type="<?php echo e("text"); ?>" class="form-control base_info text-md-right" name="ip_address"  id="ip_address" value="<?php echo e($local_ip); ?>" placeholder="192.100.10.21">
					<?php else: ?>
					<input type="<?php echo e("text"); ?>" class="form-control base_info text-md-right" name="ip_address"  id="ip_address" value="<?php echo e($local_ip); ?>" placeholder="192.100.10.21">
					<?php endif; ?>
                </div> 
			...
			<div class="form-group row" class="class_container" id="class_container1">
				...
				<div class="col-md-2">
					<select class="form-control class_type" style="height: 33px !important">
						<?php $__currentLoopData = config('consts')['CLASS_TYPE']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$classType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
							<option value="<?php echo e($key); ?>"> <?php echo e($classType); ?></option>
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
					</select>
				</div>
...
<!--						</div>-->
<!--						<div class="col-md-5">-->
<!--							<label class="control-label text-md-left" id="total_members" members="<?php echo e($totalMembers); ?>"><?php echo e($totalMembers); ?> 名</label>-->
<!--						</div>-->
<!--					</div>-->
<!--					<div class="row">-->
<!--						<div class="col-md-7">-->
...
<!--						</div>-->
<!--						<div class="col-md-5">-->
<!--							<label class="control-label text-md-left" id="total_price"><?php echo e($totalMembers*1200); ?>  円</label>-->
<!--						</div>-->
<!--					</div>-->
<!--				</div>-->
			</div>
				...
				<div class="col-md-12">
					...
					<table class="table table-bordered" id="class_table">
					    ...
					    <tbody class="text-md-center">						
							...
							<tr id="trc_<?php echo e($class->id); ?>" cid="<?php echo e($class->id); ?>">
								<td><?php echo e(config('consts')['CLASS_TYPE'][$class->type]); ?></td>
								<td><?php if($class->grade != 0 ): ?><?php echo e($class->grade); ?><?php endif; ?></td>
								<td><?php echo e($class->class_number); ?></td>
								<td><?php echo e($class->member_counts); ?></td>
					...
					<table class="table table-bordered" id="sum_table">
						<tr>
							<td>合計（児童生徒を含む人数）:</td>
							<td id="total_members" members="<?php echo e($totalMembers); ?>"><?php echo e($totalMembers); ?> 名</td>
							<td>会費合計（児童生徒を含める場合の年額）</td>
							<td id="total_price"><?php echo e($totalMembers*1200); ?>  円</td>
						</tr>
						<tr>
							<td>合計（児童生徒を含めない人数）:</td>
							<td id="nopupil_total_members" members="<?php echo e($nopupiltotalMembers); ?>"><?php echo e($nopupiltotalMembers); ?> 名</td>
							<td>会費合計（児童生徒を含めない場合の年額）</td>
							<td id="nopupil_total_price"><?php echo e($nopupiltotalMembers*1200); ?>  円</td>
						</tr>
					</table>
...
//				$(".class_number").val(1);
			...
			$("#class_add").click(function(){
				...
				if(class_type == -1 || class_grade == -1 ){
					...
					$("#alert_text").html("<?php echo e(config('consts')['MESSAGES']['WRONG_DATA']); ?>");
	        		$("#alertModal").modal();
				}else if(members == '' || members < 1){
					$("#alert_text").html("<?php echo e(config('consts')['MESSAGES']['NUMBERS_DATA']); ?>");
	        		$("#alertModal").modal();
				}else{
					$.get("<?php echo (isset($_SERVER['HTTPS']) ? 'https' : 'http').'://'.$_SERVER['HTTP_HOST'] ?>/classes/check?type="+class_type+"&grade="+class_grade+"&group_id="+group_id+"&class_number="+class_number+"&cid="+cid,
						...
						if(data == "false"){
							//alert("please select correct Class Type, Grade");
							$("#alert_text").html("<?php echo e(config('consts')['MESSAGES']['WRONG_MEMBERDATA_DOUBLE']); ?>");
	        				$("#alertModal").modal();
						}else{
