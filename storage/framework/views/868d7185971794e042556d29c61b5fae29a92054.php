		...
		<div class="form-horizontal">
			...
			<table class="table table-bordered">
			    <tbody class="text-md-center">
			 		<tr>
				        ...
				        <td colspan="2"><?php echo e($user->group_name); ?> (<?php echo e($user->group_yomi); ?>)</td>
					</tr>
					<tr>
				        <td class="info">代表者名</td>
				        <td colspan="2"><?php echo e($user->rep_name); ?></td>
					</tr>
					<tr>
				        <td class="info">住所</td>
				        <td colspan="2">〒 <?php echo e($user->address4); ?>―<?php echo e($user->address5); ?> <?php echo e($user->address1); ?> <?php echo e($user->address2); ?> <?php echo e($user->address3); ?> </td>
					</tr>
					<tr>
				        <td class="info">電話</td>
					...
					<tr>
				        ...
				        <td colspan="2"><?php echo e($user->teacher); ?></td>
				        <!-- <td><strong>Wi-fi: </strong> <?php echo e($user->getWifi()); ?> </td> -->
					</tr>
					<tr>
					...
					<tr>
				        ...
				        <!--<td><a href="<?php echo e(asset($user->authfile)); ?>" download>添付ファイル</a></td>-->
				        <td><a href="<?php echo e(url('/auth/download/'.$user->username.'')); ?>">添付ファイル</a></td>
					</tr>
					<tr>
				        <td class="info">申込人数合計</td>
				        <td colspan="2"><span class="text-danger"><?php echo e($user->totalMemberCounts()); ?></span> 名  詳細は下記</td>
					</tr>
					...
					<tr>
				        ...
				        <td><?php echo e($user->totalMemberCounts()); ?> 名</td>
				        <td></td>
					</tr>
					<tr>
				        <td class="warning">合計金額（年額）</td>
				        <td>（団体システム使用料年額<span class="text-danger"><?php echo e(config('consts')['YEAR_FEE']); ?></span>円/人）</td>
				        <td>
				        	<span class="text-danger">
				        		<?php echo e($user->groupFeePlan()); ?> 円	
				        	</span>
			        	</td>
					</tr>
					<tr>
				        <td class="warning">合計（児童生徒を含めない人数）</td>
				        <td><?php echo e($user->nopupiltotalMemberCounts()); ?> 名</td>
				        <td></td>
					</tr>
					<tr>
				        <td class="warning">合計金額（年額）</td>
				        ...
				        <td>
				        	<span class="text-danger">
				        		<?php echo e($user->nopupilgroupFeePlan()); ?> 円	
				        	</span>
			        	</td>
					</tr>
					<tr>
				        <td class="danger"> 読Qネーム</td>
				        <td colspan="2"><?php echo e($user->username); ?> （全表示)</td>
					</tr>
					<tr>
				        <td class="danger">パスワード</td>
				        <td colspan="2"><?php echo e($user->passwordShow()); ?> （安全のため下２文字のみ表示）</td>
					</tr>
			...
			<div class="form-group form-actions row">
				<div class="offset-md-4 col-md-4 text-md-center col-sm-12">
					<a href="<?php echo e(url('/auth/reg_step4/'.$user->role.'/suc?refresh_token='.$user->refresh_token)); ?>" class="btn btn-success" style="margin-bottom:8px">確認して登録完了</a>
				</div>
