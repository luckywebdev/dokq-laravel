...
<?php $__env->startSection('contents'); ?>
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title">本の編集(確認画面)</h3>
			...
			<div class="row">
				...
				<div class="col-md-8">
                    ...
                    <div class="form">
						...
						<?php echo $__env->make('books.book.confirmform', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                        <br><br>
                        ...
                        <div class="col-md-3">
                            ...
                            <?php else: ?>
                                <button type="button" class="btn btn-success update-close" style="margin-top:8px;"><i class="fa fa-check"></i>情報を更新する</button>
                            <?php endif; ?>
                        </div>
                        <div class="col-md-4">
                            <?php if(isset($book) && $book->register_id == Auth::id()): ?>
...
//                  alert(last_input);
            ...
            $(".btn_confirm").click(function(){
                $("#book-register-form").attr("method", 'post');
                $("#book-register-form").attr('action', '/book/book_confirm');
                $("#book-register-form").submit();
            })
