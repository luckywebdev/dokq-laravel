	...
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title">
				...
				<small><?php echo $current_season['year']-1 ?>年度に獲得したポイント</small>
			</h3>
		...
		<form action=<?php echo e(url('/group/rank/4')); ?> id="selectGrade" name="rank4-form" method = "GET">
