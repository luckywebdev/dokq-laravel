						...
						<div class="form-group">
							...
							<div class="col-md-4">
								<select class="form-control input-large select2me" name="history_item" id="history_item" data-placeholder="選択...">
									<option value=""></option>
									<?php $__currentLoopData = $history_item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item_key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php if($item_key == 'home_top' || $item_key == 'book_page' || $item_key == 'my_page' || $item_key == 'otherviewer' || $item_key == 'admin_page'): ?>
											<?php $disabled = 'disabled'; ?>
										<?php else: ?>
											<?php $disabled = ''; ?>
										<?php endif; ?>
										<option value="<?php echo e($item_key); ?>" <?php echo e($disabled); ?> <?php if($item_key == $selected_item): ?> selected <?php endif; ?>><?php echo e($item); ?></option>
	...
	<script type="text/javascript">
		...
		$("#next_btn").click(function(){
            ...
            if($("select[name=history_item]").val() == 'home_top'){
                ...
                $("#data_result").attr('action', '<?php echo e(url("/admin/exportQuizemake")); ?>');
                $("#data_result").submit();
                return;
