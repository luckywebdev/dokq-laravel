				...
				<div class="col-md-12">
					<form class="form-horizontal form" action="<?php echo url('book').'/'.$book->id.'/res_passer'; ?>" method="post">
						...
						<div class="form-group row">
							<h4 class="control-label col-md-12 text-md-center">タイトル: {{$book->title}}</h4>
						</div>
						...
						<div class="row">
							...
							<div class="col-md-2">
								<a class="btn btn-danger" @if($book->active >= 3) href="<?php echo url('book').'/'.$book->id.'/detail'; ?>"@endif style="margin-bottom:8px;">キャンセル</a>
							</div>
                            <div class="col-md-4">
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$(".search_btn").click(function() {
				...
				if(name == '' && username == ''){
					$("#alert_text").html("{{config('consts')['MESSAGES']['FULLNAME_USERNAME_ALERT']}}");
	            	$("#alertModal").modal();
				}else
