			...
			<div style="padding: 20px">
				<table>
					<tbody class="text-md-center">
						...
						<tr>
							<td colspan="2">
								退会手続きが完了しました。このメールに心当たりが無い場合、読Q宛に、お問合せ欄からご連絡ください。なお、読Qでは、あなたのアカウントを退会後も3カ月間保持します。退会していた間の会費を納めていただければ、3か月以内なら復活することが可能ですので、お問合せ欄からご連絡いただきます。<br>
							</td>
						</tr>
						 <tr>
						    <td colspan="2"><br>
