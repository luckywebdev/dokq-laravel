				...
				<div class="form">
					...
					<div class="col-md-12">
						...
						<div class="col-md-5">
							...
							<textarea class="col-md-10" rows="3" name="top_page_left">{{(isset($advise)? $advise->top_page_left: '')}}</textarea>
						</div>
						<div class="col-md-5">
							<label class="control-label col-md-2 text-md-left"><strong>右&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;側:<br>234 x 60 </strong></label>
							<textarea class="col-md-10" rows="3" name="top_page_right">{{(isset($advise)? $advise->top_page_right: '')}}</textarea>
						</div>
					</div>
					<div class="col-md-12">
						...
						<div class="col-md-5">
							...
							<textarea class="col-md-10" rows="3" name="mystudy_top">{{(isset($advise)? $advise->mystudy_top: '')}}</textarea>
						</div>
						<div class="col-md-5">
							<label class="control-label col-md-2 text-md-left"><strong>底&nbsp;&nbsp;部&nbsp;&nbsp;側:<br>234 x 60 </strong></label>
							<textarea class="col-md-10" rows="3" name="mystudy_bottom">{{(isset($advise)? $advise->mystudy_bottom: '')}}</textarea>
						</div>
					</div>
					<div class="col-md-12">
						...
						<div class="col-md-4">
							...
							<textarea class="col-md-10" rows="3" name="book_page_top_left">{{(isset($advise)? $advise->book_page_top_left: '')}}</textarea>
						</div>	
						<div class="col-md-4">
							<label class="control-label col-md-2 text-md-left"><strong>右&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上:<br>468 x 60 </strong></label>
							<textarea class="col-md-10" rows="3" name="book_page_top_right">{{(isset($advise)? $advise->book_page_top_right: '')}}</textarea>
						</div>	
						<div class="col-md-4">
							<label class="control-label col-md-2 text-md-left"><strong>右&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;下:<br>234 x 60 </strong></label>
							<textarea class="col-md-10" rows="3" name="book_page_bottom_right">{{(isset($advise)? $advise->book_page_bottom_right: '')}}</textarea>
						</div>	
					</div>
					<div class="col-md-12">
						...
						<div class="col-md-5">
							...
							<textarea class="col-md-10" rows="3" name="search_page_top">{{(isset($advise)? $advise->search_page_top: '')}}</textarea>
						</div>
					</div>
				</div>
			</form>
