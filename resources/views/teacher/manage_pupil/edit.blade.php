...
@section('contents')
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-12">
					@include('teacher.manage_pupil.register_form')
				</div>
			</div>
			<div class="row">
...
@section('scripts')
    ...
    <script type="text/javascript" src="{{asset('js/teacher/pupil-form.js')}}"></script>
	<script type="text/javascript">
				...
				bootbox.dialog({
	                ...
	                buttons: {
	                  success: {
	                    ...
	                    className: "yellow",
	                    callback: function() {
	                    	location.href="{{url('/teacher/pupil/remove')}}?id="+$("#pupil_id").val();
	                    }
	                  },
	                  main: {
	                    label: "削除しない",
		...
		$(".move_btn").click(function(){
			...
			/*if($("#pupil_id").val() == 0){
            	...
            	location.href="{{url('/teacher/edit_pupil')}}?pupil="+$("#pupil_id").val();
			}*/
		})
		$(".confirm").click(function(){
			if($("#pupil_id").val() > 0){				
            	location.href="{{url('/teacher/pupil/move')}}?pupil="+$("#pupil_id").val();
			}
		})
		...
		$(".graduateconfirm").click(function(){
			if($("#pupil_id").val() > 0){				
            	location.href="{{url('/teacher/pupil/graduate')}}?pupil="+$("#pupil_id").val();
			}
		})
