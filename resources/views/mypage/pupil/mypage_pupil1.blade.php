								...
								<table class="table table-bordered table-hover">
									...
									<tbody class="text-md-center">
										...
										<tr>
											...
											<td class="text-md-center align-middle"><a href="{{url('book/search_books_byauthor?writer_id=' . $book->writer_id.'&fullname='.$book->fullname_nick())}}">{{$book->fullname_nick()}}</a></td>
...
@section('scripts')
	...
	<script>
		...
		var quarters_point = [
			...
			@if ($type == 0 && $user->role == config('consts')['USER']['ROLE']['PUPIL'] && $user->active == 1)
	  ...
	  //       }
	@if ($user->role == config('consts')['USER']['ROLE']['PUPIL'] && $user->active == 1)
	var member_interval = 50;
	var points_interval = 5;
		@if($type == 0)		
			var myrank1 = 1;
...
<?php endforeach ?>;
max_xValue = Math.floor(top_point / points_interval) + 1;
var numofLevel = new Array(max_xValue);
for(var i = 0; i < max_xValue; i++)
	numofLevel[i] = 0;
<?php foreach ($myrankPoints1 as $i => $rank): ?>
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			var settings = {
				...
				legendLayout : { left:10 , top: 0, width:100, height:100, flow: 'vertical' },
				...
				xAxis:
				{
					dataField: 'x_point',
					minValue:0,
					maxValue:Math.floor(top_point / points_interval + 1) * points_interval,
					...
					[
						{
							...
							series: [
							{ dataField: 'value_member', displayText:null, colorFunction: function (value, itemIndex, serie, group) {
			...
			// setup the chart
			$('#horizontal-chart1').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#horizontal-chart2').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#horizontal-chart3').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#horizontal-chart4').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#horizontal-chart5').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#threemonth-chart1').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#threemonth-chart2').jqxChart(settings);
		@endif
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#threemonth-chart3').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#threemonth-chart4').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#threemonth-chart5').jqxChart(settings);
...
for(var i = 0; i < max_xValue; i++)
	max_members = Math.max(max_members, numofLevel[i]);
			...
			// setup the chart
			$('#all-chart5').jqxChart(settings);
///////////////////////////////////////////////////////////////////////	
var mouse_hover = function(){
			
			$('#horizontal-chart1 .jqx-chart-legend-text').html(myrank1+"位/"+myrank_pupils1+"人");


			$('#horizontal-chart2 .jqx-chart-legend-text').html(myrank2+"位/"+myrank_pupils2+"人");

			$('#horizontal-chart3 .jqx-chart-legend-text').html(myrank3+"位/"+myrank_pupils3+"人");

			$('#horizontal-chart4 .jqx-chart-legend-text').html(myrank4+"位/"+myrank_pupils4+"人");

			$('#horizontal-chart5 .jqx-chart-legend-text').html(myrank5+"位/"+myrank_pupils5+"人");

			$('#threemonth-chart1 .jqx-chart-legend-text').html(threemonthrank1+"位/"+threemonthrank_pupils1+"人");
 
			$('#threemonth-chart2 .jqx-chart-legend-text').html(threemonthrank2+"位/"+threemonthrank_pupils2+"人");
 
			$('#threemonth-chart3 .jqx-chart-legend-text').html(threemonthrank3+"位/"+threemonthrank_pupils3+"人");

			$('#threemonth-chart4 .jqx-chart-legend-text').html(threemonthrank4+"位/"+threemonthrank_pupils4+"人");
   
			$('#threemonth-chart5 .jqx-chart-legend-text').html(threemonthrank5+"位/"+threemonthrank_pupils5+"人");
   
			$('#all-chart1 .jqx-chart-legend-text').html(allrank1+"位/"+allrank_pupils1+"人");
  
			$('#all-chart2 .jqx-chart-legend-text').html(allrank2+"位/"+allrank_pupils2+"人");
	 
			$('#all-chart3 .jqx-chart-legend-text').html(allrank3+"位/"+allrank_pupils3+"人");

			$('#all-chart4 .jqx-chart-legend-text').html(allrank4+"位/"+allrank_pupils4+"人");

			$('#all-chart5 .jqx-chart-legend-text').html(allrank5+"位/"+allrank_pupils5+"人");

};		
			mouse_hover();
			$(window).resize(function(){
				window.setTimeout(mouse_hover, 500);
			});
			$(window).hover(mouse_hover);
		@endif
		});
