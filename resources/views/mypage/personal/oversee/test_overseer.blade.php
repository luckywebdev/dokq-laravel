	...
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div>
				...
				<input type="hidden" id="aptitude" name="aptitude" value="{{$aptitude}}">
					...
					success: function (response) {
						...
						if(response.result) {
							$('#test_content').append(
								...
								+			'</div>'
								+			'<div class="col-md-3">'
								+				'<a href="' + "{{url('/mypage/oversee_test')}}" + '" class="btn btn-info pull-right">試験監督を始める</a>'
								+			'</div>'
								+			'<div class="col-md-3">'
								+				'<a href="' + "{{url('/mypage/top')}}" + '" class="btn btn-info pull-right">マイ書斎へ戻る</a>'
								+			'</div>'
								+		'</div>'
								+	'</div>'
								+'</div>'
