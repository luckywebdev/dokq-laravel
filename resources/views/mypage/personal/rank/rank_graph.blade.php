...
@section('contents')
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title">読Qポイント順位グラフ<span style="font-size:12px">@if($user->isPupil() && $user->active == 1)（同学年内） @else（同年代と競うグラフ）@endif</span>
			</h3>
			<div class="row ">
	...
	<script>
		...
		@if($type == 0)
			...
			<?php foreach ($lastyearrankPoints1 as $i => $rank ): ?>
					lastrank_pupils1 = lastrank_pupils1 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						lastrank1 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
			...
			<?php foreach ($lastyearrankPoints2 as $i => $rank ): ?>
					lastrank_pupils2 = lastrank_pupils2 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						lastrank2 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
		...
		@endif
			...
			<?php foreach ($lastyearrankPoints3 as $i => $rank ): ?>
					lastrank_pupils3 = lastrank_pupils3 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						lastrank3 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
			...
			<?php foreach ($lastyearrankPoints4 as $i => $rank ): ?>
					lastrank_pupils4 = lastrank_pupils4 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						lastrank4 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
			...
			<?php foreach ($lastyearrankPoints5 as $i => $rank ): ?>
					lastrank_pupils5 = lastrank_pupils5 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						lastrank5 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
		...
		@if($type == 0)
			...
			<?php foreach ($beforethreemonthrankPoints1 as $i => $rank ): ?>
					beforethreemonthrank_pupils1 = beforethreemonthrank_pupils1 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						beforethreemonthrank1 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
					top_point = Math.max(top_point, {{$rank->sum}});
			<?php endforeach ?>;
			...
			<?php foreach ($beforethreemonthrankPoints2 as $i => $rank ): ?>
					beforethreemonthrank_pupils2 = beforethreemonthrank_pupils2 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						beforethreemonthrank2 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
					top_point = Math.max(top_point, {{$rank->sum}});
			<?php endforeach ?>;
		...
		@endif
			...
			<?php foreach ($beforethreemonthrankPoints3 as $i => $rank ): ?>
					beforethreemonthrank_pupils3 = beforethreemonthrank_pupils3 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						beforethreemonthrank3 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
					top_point = Math.max(top_point, {{$rank->sum}});
			<?php endforeach ?>;
			...
			<?php foreach ($beforethreemonthrankPoints4 as $i => $rank ): ?>
					beforethreemonthrank_pupils4 = beforethreemonthrank_pupils4 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						beforethreemonthrank4 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
					top_point = Math.max(top_point, {{$rank->sum}});
			<?php endforeach ?>;
			...
			<?php foreach ($beforethreemonthrankPoints5 as $i => $rank ): ?>
					beforethreemonthrank_pupils5 = beforethreemonthrank_pupils5 + {{$rank->pupil_numbers}};
					@if($rank->flag=='1')
						beforethreemonthrank5 = {{$i+1}};
						my_points = {{$rank -> sum}};
					@endif		
					top_point = Math.max(top_point, {{$rank->sum}});
			<?php endforeach ?>;
