						...
						<table class="table table-bordered table-hover text-md-center" @if(!$otherview_flag) id="passhistory_author_order1" @else id="passhistory_author_order2" @endif>
							...
							<tbody class="text-md-center">
								...
								<tr class="info">
									...
									<td>{{date_format(date_add(date_create($passed_quiz_record->finished_date), date_interval_create_from_date_string($passed_quiz_record->passed_test_time."seconds")), "Y-m-d H:i:s")}}</td>
