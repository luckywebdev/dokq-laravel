	...
	<div align='left' name = "idprint">
		<div class="page-content-wrapper">
			<div class="page-content">
				<h3 class="page-title col-md-12" style="text-align:center">
					...
					<div class="col-md-6">
						<div class="news-blocks lime">
							...
							<table class="table table-no-border">
								...
								<tr>
									<td width="60%" style="text-align:center">{{$book->title}}</td>
									<td width="40%" style="text-align:center">{{$book->firstname_nick.' '.$book->lastname_nick}}</td>
								</tr>
								@endforeach
							</table>
						</div>
