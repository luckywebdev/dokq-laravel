						...
						<div class="row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-xs-6" style="float: right;">
                                    <span class="text-md-right  text-md-top" style="float:right;font-size:14px;">{{date("Y").'年'.date("m").'月'.date("d").'日'}}</span>
                                </div>
                            </div>  
							...
							<div class="col-md-12 col-xs-12">
								...
								<h5 class="text-md-center" style="text-align:center;font-size:14px;">（パスコード：　{{$certi_preview->passcode}}）</h5>
							</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-left" style="text-align:left;font-size:14px;">{{$user->fullname()}}　様</div>
							<div class="col-md-12 col-xs-12 text-md-left" style="text-align:left;font-size:14px;">(読Qネーム：　{{$user->username}})</div>
							<div class="col-md-12 col-xs-12 text-md-right" style="text-align:rigth;" >
								<div class="col-md-7 col-xs-8"></div>
								<div class="background_print col-md-5 col-xs-4" style="float:right;background-image: url({{asset('/img/sign2.png')}}) !important;background-repeat: no-repeat !important;background-position: center center !important;height:100px;">
									<br><br>
							...
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-center" style="text-align:center;font-size:14px;">読Q検定&nbsp;&nbsp;　{{$certi_preview->level}}級</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-center" style="text-align:center;font-size:14px;">合計取得ポイント　　{{floor($certi_preview->sum_point*100)/100}}&nbsp;ポイント</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-center" style="text-align:center;font-size:14px;">({{date_format(date_create($certi_preview->backup_date), 'Y年m月d日')}} 現在)</div>
							<div class="col-md-12 text-md-left">&nbsp;</div>
					...
					?>
						<div style="height:28.7cm;border:solid 1px;padding:20px;">
							<div class="row">
								...
								<div class="col-md-12 col-xs-12 text-md-center" style="text-align:center;font-size:14px;">合計取得ポイント　　{{floor($certi_preview->sum_point*100)/100}}&nbsp;ポイント</div>	
								<div class="col-md-12 text-md-left">&nbsp;</div> 
								<div class="col-md-12 col-xs-12 text-md-center" style="text-align:center;font-size:14px;">合格した書籍一覧（著者名順）　　　　（{{ date("Y") }}年{{date("n")}}月{{date("d")}}日現在)</div>    
								
								<!--<div class="col-md-12 text-md-left">&nbsp;</div>	
								<div class="col-md-12 col-xs-12">      
									<div class="col-md-6 col-xs-6 text-md-center" style="float:left; text-align:center;font-size:14px;">合格した書籍一覧（著者名順）</div>
									<div class="col-md-6 col-xs-6 text-md-right" style="float:right; text-align:right;font-size:14px;">{{date_format(date_create($certi_preview->backup_date), 'Y年m月d日')}}現在</div>                                                                 
								</div>-->
					...
					<div style="height:28.7cm;border:solid 1px;padding:20px">
						<div class="row">
                            <div class="col-md-12 col-xs-12">
                                ...
                                <div class="col-md-6 col-xs-6" style="float: right;">
                                    <span class="text-md-right" style="text-align:right;float:right;font-size:14px;">{{date("Y").'年'.date("m").'月'.date("d").'日'}}</span>
                                </div>
                            </div>             
							...
							<div class="col-md-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 text-md-left" style="text-align:left;font-size:14px;">{{$user->fullname()}}　様</div>
							<div class="col-md-12 text-md-left" style="text-align:left;font-size:14px;">(読Qネーム：　{{$user->username}})</div>
							<div class="col-md-12 text-md-left">&nbsp;</div>
							<div class="col-md-12 col-xs-12 text-md-right" style="text-align:rigth;" >
								<div class="col-md-7 col-xs-8"></div>
								<div class="background_print col-md-5 col-xs-4" style="float:right;background-image: url({{asset('/img/sign2.png')}}) !important;background-repeat: no-repeat !important;background-position: center center !important;height:100px;">
	...
	<script type="text/javascript">
        ...
        $(document).ready(function(){
			...
			setTimeout(function(){
              ...
              //location.href = "/mypage/passcode?pwd="+{{$user->passcode}};
           },2000);
