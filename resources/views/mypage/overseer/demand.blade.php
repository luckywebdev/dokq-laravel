...
@section('contents')
	<div class="page-content-wrapper">
		<div class="page-content">
			...
			<div class="row">
				<div class="col-md-9">
					<form action="{{url('/mypage/demand')}}" method="post" id="book_form">
						{{csrf_field()}}
						<div class="form-group1">
							<div class="col-md-12">
								...
								<div class="col-md-6">
									<input type="hidden" name="book_id" id="book_id" value="{{isset($_GET['book_id']) ? $_GET['book_id'] : ''}}"/>
									<input type="hidden" name="bookId" id="bookId"/>
									<input type="hidden" name="title" id="title" value="@if(isset($title)){{ $title}}@endif"/>
									<textarea type="text" id="reason" class="form-control"  name="reason" placeholder="応募理由（100字以内）" style="margin-bottom:8px;">@if(isset($reason)){{$reason}}@endif</textarea>
