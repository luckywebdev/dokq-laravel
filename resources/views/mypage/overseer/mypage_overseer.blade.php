				...
				<div class="col-md-6 column">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="{{url('/mypage/demand_list')}}">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box yellow">
						<div class="portlet-title">
							...
							@if ($age >= 15)
							<div class="tools">
								<input type="checkbox" @if ($mybookcase_is_public == 1)checked @endif class="make-switch" id="mybookcase_is_public" data-size="small">
							</div>
							@endif
						</div>
						<div class="portlet-body">
							<div class="row">
								...
								<div class="col-md-12">
									<a class="" href="{{url('mypage/category')}}">もっと見る</a>
								</div>
							</div>
						</div>
					</div>
							...
							<div class="table-scrollable">
								<table class="table table-bordered table-hover">
									...
									<tbody class="text-md-center">
										...
										<tr class="info text-md-center">
											<td class="align-middle"><a @if($demand->Book->active >= 3) href="{{url('/book/' . $demand->Book->id . '/detail')}}" @endif class="font-blue-madison">{{$demand->Book->title}}</a></td>
											<td class="align-middle"><a href="{{url('book/search_books_byauthor?writer_id=' . $demand->Book->writer_id.'&fullname='.$demand->Book->firstname_nick.' '.$demand->Book->lastname_nick)}}" class="font-blue-madison">{{$demand->Book->firstname_nick.' '.$demand->Book->lastname_nick}}</a></td>
											<td class="align-middle">dq{{$demand->Book->id}}</td>
											<td class="align-middle">@foreach($demand->Book->category_names() as $one) {{$one."、"}} @endforeach</td>
											<td class="align-middle">{{floor($demand->Book->point*100)/100}}</td>
										</tr>
										@endforeach
									</tbody>
								</table>
								...
								<table class="table table-bordered table-hover">
									...
									<tbody class="text-md-center">
										...
										<tr class="info text-md-center">
											...
											<td class="align-middle">{{floor($book->point*100)/100}}</td>
											<td class="align-middle">{{$book->is_public == 1 ? '公開':'非公開'}}</td>
										</tr>
										@endforeach
									</tbody>
								</table>
