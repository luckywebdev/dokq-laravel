				...
				<div class="col-md-6 column">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="{{url('/mypage/mybooklist')}}">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box red">
						<div class="portlet-title">
							...
							@if ($age >= 15)
								<div class="tools">
									<input type="checkbox" @if ($author_readers_is_public == 1) checked @endif class="make-switch" data-size="small" id="author_readers_is_public">
								</div>
							@endif
						</div>
						<div class="portlet-body">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="{{url('/mypage/overseer_books')}}">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box red">
						...
						<div class="portlet-body">
							<div class="row">
									...
									<a href="{{url('/mypage/category')}}" class="news-block-btn">もっと見る</a>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="portlet box green">
						...
						<div class="portlet-body">
							...
							<a class="text-md-center font-blue-madison" href="{{url('/mypage/bid_history')}}">もっと見る</a>
						</div>
					</div>
					...
					<div class="portlet box purple">
						...
						<div class="portlet-body">
							<div class="table-scrollable">
								<table class="table table-bordered table-hover">
									...
									<tbody class="text-md-center">
										...
										<tr class="info">
											<td class="text-md-center align-middle"><a @if($book->active >= 3) href="{{ url("/book/" . $book->id . "/detail") }}" @endif class="font-blue-madison">{{$book->title}}</a></td>
											<td class="text-md-center align-middle"><a href="{{ url('/book/search_books_byauthor?writer_id=' . $book->writer_id.'&fullname='.$book->firstname_nick.' '.$book->lastname_nick) }}" class="font-blue-madison">{{$book->firstname_nick.' '.$book->lastname_nick}}</a></td>
							...
							<a class="text-md-center font-blue-madison" href="{{ url("/mypage/wish_list") }}">もっと見る</a>
						</div>
					</div>
				...
				<div class="col-md-6 column">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body" style="height: 360px;">
							...
							<a class="text-md-center font-blue-madison" href="{{url('/mypage/rank_by_age')}}">もっと見る</a>
						</div>
					</div>
					<div class="col-md-12">
...
@section('scripts')
	...
	<script>
		...
		<?php foreach ($mywriteChartBooks as $book ): ?>
			aurthorLabel.push('{{$book->title}}'.toString());
		<?php endforeach ?>
		...
		var len_max = 0;
		<?php foreach ($mywriteChartBooks as $book ): ?>
			len_max = len_max < '{{$book->title}}'.length?'{{$book->title}}'.length:len_max;
		<?php endforeach ?>
