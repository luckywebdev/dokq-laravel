...
@section('contents')
	<div class="page-content-wrapper">
		<div class="page-content">
			<h3 class="page-title">読Q 団体教職員名簿: {{$group->group_name}}</h3>

			<div class="row">
				<div class="col-md-12">
					@if(isset($message))
						@include('partials.alert',array('message'=>$message))	
					@endif
					<div class="form-horizontal">
						...
						<div class="form-group row">
							<div class="col-md-12">
								@include('group.teacher_set.table')
							</div>
						</div>
...
@section('scripts')
	...
	<script type="text/javascript" src="{{asset('js/group/group_data_table.js')}}"></script>
   			...
   			$("#action").change(function(){
				...
				for(var i = 0; i < checkids.length; i++){
   				...
   				if($(':selected').attr('id') == 'edit'){
						...
						$("#alert_text").html("{{config('consts')['MESSAGES']['CHECK_TEACHER']}}");
	        			$("#alertModal").modal();
						$(this).val("");
						return;
   	   	   			}
						...
						$("#alert_text").html("{{config('consts')['MESSAGES']['CHECK_ONETEACHER']}}");
	        			$("#alertModal").modal();
						$(this).val("");
						return;
   	   	   			}
...
//						
            ...
            $(".delete_teacher").click(function(){
                ...
                $("#form").attr("action",'{{url("/group/teacher/delete")}}');
                $("#form").submit()
            });
		});
		TableManaged.init();
    </script>
	<script type="text/javascript" src="{{asset('js/group/list.js')}}"></script>
@stop