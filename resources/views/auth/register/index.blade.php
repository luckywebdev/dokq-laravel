...
@section('breadcrumb')
	<div class="breadcum">
	    <div class="container-fluid">
	        <ol class="breadcrumb">
	            <li>
	                <a href="{{url('/')}}" style="font-family: 'Judson'">
						読Q
	                </a>
	            </li>
	            <li class="hidden-xs">
...
@section('contents')
	...
	<form class="form-horizontal form" method="post" id="form-validation" role="form" action="{{ url('/auth/viewpdf') }}">
		{{csrf_field()}}	
		<div class="row justify-content-md-center">
			...
			<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				<div class="dashboard-stat red-intense">
					...
					<a href="{{url('/auth/register/2/1')}}" style="cursor: pointer">
		...
		<div class="row">
			<div class="col-sm-12">
				<a href="{{url('/')}}" class="btn btn-info float-right">読Qトップへ戻る</a>
			</div>
		</div>
...
<script type="text/javascript">
	...
	$("#viewpdf0").click(function(){
    	...
    	$(".form-horizontal").attr("action", '{{url("/auth/viewpdf")}}');
