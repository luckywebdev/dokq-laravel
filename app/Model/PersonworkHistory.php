...
class PersonworkHistory extends Model
{
    ...
    protected $fillable = ['id','user_id', 'certi_backup_id', 'username','item','work_test','user_type','age','address1','address2','org_username','content', 'device','pay_point','period','created_at', 'updated_at'];
    ...
    */
    ...
    public function certiBackup(){
    	return $this->belongsTo('App\Model\CertiBackup', 'certi_backup_id');
    }
