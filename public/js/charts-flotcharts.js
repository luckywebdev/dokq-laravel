var ChartsFlotcharts = function() {
    ...
    return {
        ...
        initBarCharts: function() {
            ...
            if ($('#chart_1_2_1').size() !== 0) {
                $.plot($("#chart_1_2_1"), [data1], options);
            }

            if ($('#chart_1_2_2').size() !== 0) {
                $.plot($("#chart_1_2_2"), [data1], options);
            }

            if ($('#chart_1_2_3').size() !== 0) {
                $.plot($("#chart_1_2_3"), [data1], options);
            }

            if ($('#chart_1_2_4').size() !== 0) {
                $.plot($("#chart_1_2_4"), [data1], options);
            }
        },
